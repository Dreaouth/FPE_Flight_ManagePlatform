...
<h1 align="center" >后台注册</h1>
  <div id="loginform" class="loginBox">
    <form onsubmit="return check()" action="check_register" method="post">
      <div class="formRow user">
        ...
        <p class="form-control-note" style="color: #ff0000" align="right">已存在该用户名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <%} else {%>
        <%}%>
      <div class="formRow user">
          <input id="e_mail" name="e_mail" type="text" placeholder="邮箱" class="input_text input-big" autocomplete="off">
      </div>
        <%if (request.getAttribute("check") == "2") {%>
        <p class="form-control-note" style="color: #ff0000" align="right">邮箱格式错误&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <%} else {%>
        <%}%>
      ...
      <div class="formRow password">
        ...
        <%if (request.getAttribute("check") == "3") {%>
        <p class="form-control-note" style="color: #ff0000" align="right">两次密码输入不一致&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <%} else {%>
        <%}%>
      <div class="formRow">
