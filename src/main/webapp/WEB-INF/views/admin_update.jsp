...
<%
    ...
    String status = (String) request.getParameter("permission");
    if (status == null) {
        status = "";
    }
%>
<div class="pd-20">
    <div class="Huiform">
        <form action="admin/updateAdmin" method="post" onsubmit="return check()" target="_parent">
            <table class="table table-bg">
                <tbody>
                <tr>
                    <th width="100" class="text-r"><span class="c-red">*</span> 用户ID：</th>
                    <td><input type="text" style="width:300px" class="input-text" id="id" name="id" readonly="readonly"
                               value=<%=id %>></td>
                </tr>
                <tr>
                    <th width="100" class="text-r"><span class="c-red">*</span> 用户名：</th>
                    <td><input type="text" style="width:300px" class="input-text" id="name" name="name"
                               value=<%=username %>></td>
                </tr>
                <tr>
                    <th class="text-r"><span class="c-red">*</span> 密码：</th>
                    <td><input type="text" style="width:300px" class="input-text" id="password" name="password"
                               value=<%=password %>></td>
                </tr>
                <tr>
                    <th class="text-r"><span class="c-red">*</span> 邮箱：</th>
                    <td><input type="text" style="width:300px" class="input-text" id="email" name="email"
                               value=<%=email %>></td>
                </tr>
                <tr>
                    <th class="text-r"><span class="c-red">*</span> 权限：</th>
                    <td><select style="width: 300px" class="select"
                                id="permission" name="permission" value=<%=status %>>
                        <option value="超级管理员">超级管理员</option>
                        <option value="信息管理员">普通管理员</option>
                    </select></td>
                </tr>
                <tr>
                    <td>
