...
<nav class="Hui-breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 机场管理 <a
        class="btn btn-success radius r mr-20"
        style="line-height: 1.6em; margin-top: 3px"
        href="queryCity" title="刷新"><i
    ...
    <div class="text-c">
        <form action="selectCity" method="post">
            城市查询： <input type="text" class="input-text" style="width: 250px"
                         placeholder="输入城市名" id="sta_name" name="sta_name"
                         value=<%=query%>>&nbsp;&nbsp;&nbsp;
            <button type="submit" class="btn btn-success">
                <i class="icon-search"></i> 查询
            </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;<a href="javascript:;" onClick="user_add('550','','添加车站','insert')"
               class="btn btn-primary radius"><i
                    class="icon-plus"></i> 添加车站</a>
        </form>
            ...
            <c:forEach items="${citylist}" var="temp">
                <tr class="text-c">
                    ...
                    <td class="f-14 user-manage"><a title="编辑"
                                                    href="javascript:;"
                                                    onClick="user_edit('4','550','','修改机场信息','update?add_id=${temp.id}&add_citycode=${temp.citycode}&add_cityname=${temp.cityname}&add_province=${temp.province}&add_drome=${temp.dromename}')"
