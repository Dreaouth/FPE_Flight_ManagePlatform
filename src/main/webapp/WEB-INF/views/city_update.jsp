...
<%
    ...
    String cityname=(String)request.getAttribute("add_cityname");
    if(cityname==null){
        cityname="";
    }
    String province=(String)request.getAttribute("add_province");
    if(province==null){
        province="";
    }
    String drome=(String)request.getAttribute("add_drome");
    if(drome==null){
        drome="";
    }
%>
